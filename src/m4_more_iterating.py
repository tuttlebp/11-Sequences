...
def run_test_count_items_bigger_than():
    ...
    # DOEN 4 (continued):  Add your 2 ADDITIONAL tests here:
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 3
    actual = count_positive_sines([-1, 4, 5, 6, 7, 8, 9])
    print()
    print('Test 1 expected:', expected)
    print('       actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    # -------------------------------------------------------------------------
    # DOEN: 8. Implement this TEST function.
